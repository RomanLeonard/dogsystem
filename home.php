<?php 
    ...
    if(isset($_POST['btn_search'])){
        ...
        if ($tabelActivate == true && $detActivate == false) $sql .= "`catei_tabel`";

        if ($detActivate == true && $tabelActivate == false) {

            $sql .= "catei_tabel WHERE c_microcip IN (SELECT DISTINCT spec_serie FROM specific_details";
        ...
        if (($tabelActivate == false && $detActivate == false) && $detaliiActivate == true) {
            ...
            $sql .= "catei_tabel WHERE c_microcip IN (SELECT DISTINCT det_serie FROM details";
        ...
        $sql = "SELECT COUNT(*) FROM catei_tabel";
        ...
        $sql = "SELECT * FROM catei_tabel LIMIT $offset, $rowsperpage";
        ...
        $sqlTotal = "SELECT * FROM catei_tabel";
...
<div id="calendar-body" class="calendar"style="width: 100%;position: absolute; height: 100vh;background: rgba(0,0,0,1);top: 0;bottom: 0; display:none; z-index:1000";>
...
<button style="position: absolute;
        ...
        <br><br><center><h3 style="color: #fff">Din motive de confidentialitate am dezactivat integrarea calendarului google din aceasta sectiune</h3></center>
</div>
